...
function switchTab(clickedTab) {
    if(clickedTab != currentTab) {
        ...
        if(!searchForm.classList.contains("active")){
            ...
            userInfoContainer.classList.remove("active");
            //ab main your weather tab me aa gaya hun toh weather bhi display karna padega , lets check local storage first..
            //for cordinates, if we need saved them there.
            getfromSessionStorage();
        }
        }
}
...
function getLocation() {
    if(navigator.geolocation){
        ...
        //HW SHOW ALERT FOR NO SUPPORT GEOLOCATION available
    }
}
